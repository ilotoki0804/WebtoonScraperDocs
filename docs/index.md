...
**포터블 버전**은 [후원](https://www.patreon.com/ilotoki0804)을 하면 이용할 수 있고 네이버 웹툰과 레진코믹스를 *포함*해 *카카오 웹툰, 카카오페이지, webtoons.com, 리디북스 웹툰, 탑툰, 봄툰, 투믹스, 버프툰, 이만배, 투비컨티뉴드, 재담쇼츠, 네이버 게임 오리지널, 네이버 블로그, 티스토리*에서도 웹툰 다운로드를 지원하며, 특별한 설치 없이도 사용 가능합니다.
